...
Lopullinen ratkaisu toimi kun latasi NTP:n, jonka jälkeen uudelleenkonfiguroi tzdatan. Nyt masterilla siis oikea aikaleima ja minionilla sama ongelma, ajattelin että tekisin salt tilan, jolla ajaisin ntp:n asennuksen mutta ei tietenkään toiminut saltin kautta, joten minionille sisäänkirjautuminen ja tein skriptin, jotta ei tarvitse näpytellä komentoja. 
