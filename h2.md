...
Virtualboxin lataaminen ei toiminut `apt-get` komennolla, joten latasin sen Oracle Virtaulboxin nettisivuilta ja sitten komennolla
...
Kuitenkin kommennolla virtualbox graafinen käyttöliittymö aukesi ja katsoin, että  se oli veriota 7.1.4. 
