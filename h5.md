...
Tein kansion salt-config, jonne laitoin apachen näkymää varten index.html, script.js, styles.css sekä images.json -[tiedostot](https://github.com/redbulls77/photogallery/tree/main/apache).  
...
Korjasin ongelman siirtämällä index.html, styles.css, images.json ja script.js -tiedostos /srv/salt/apache hakemistoon, kun ne olivat vain salt-config kansiossa. 
