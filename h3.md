...
Esimerkkinä SSH-palvelin, jossa käytössä OpenSSH -palvelin. Tässä sen tila-tiedosto sshd.sls /srv/salt -hakemistossa: 
...
3. service:llä voi hallinoida palveluiden tiloja
  ...
  - enable ottaa palvelun käyttöön kun järjestyelmä käynnistyy
...
Sphinx & Furo: 2021 - 2024. Salt User Guide. Salt states. Luettavissa: https://docs.saltproject.io/salt/user-guide/en/latest/topics/states.html#. 
